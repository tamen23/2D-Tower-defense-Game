...
public class Store {
	...
	public static int iconSize = 20; //20
	...
	public static int[] buttonID = {Value.airTowerLaser,Value.airTowerFrost,Value.airAir,Value.airAir,Value.airAir,Value.airAir,Value.airAir,Value.airTrash};
