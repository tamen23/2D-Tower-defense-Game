...
public class Mob extends Rectangle {
	...
	public int walkFrame = 0, walkSpeed = 60; //Walking Speed of mobs
	...
	public void checkDeath(){
		if(health <= 0){
			...
			//System.out.println("Value of Gold: " + Value.deathReward[mobID] + " for killing MobID: " + mobID + " Mobs killed count : " + Screen.killCount);
			deleteMob();
	...
	public void draw(Graphics g){
		if(inGame){
			...
			//for(int i = 0 ; i < 2 ; i++){
			//	g.drawImage(Screen.tileset_mob[i],x, y, width, height,null);
			//}
